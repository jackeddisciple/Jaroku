...
export const BRAND_COLOR: Record<string, string> = {
  ...
  // Gemini blue. It was MISSING while the provider was fully supported end to end — priced,
  // runnable, with its own key entry — so it fell through to MUTED and sat unbranded between two
  // branded rows, reading as a provider the product half-supports.
  google: "#4285f4",
  fake: MUTED,
  gmail: "#ea4335",
  slack: "#e01e5a",
...
// Gemini's mark, the same single-colour simple-icons path (CC0) on the same 24px grid as the two
// above. It was absent for the same reason its colour was: the provider shipped and the client's two
// hardcoded provider tables were never opened again.
const GEMINI_MARK =
