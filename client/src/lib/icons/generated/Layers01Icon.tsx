...
//
// Source: `Layers01Icon` from @hugeicons/core-free-icons. Stroke comes from `ICON.strokeWidth` at the
...
export function Layers01Icon(p: IconProps) {
  return svg(
    p,
    <>
