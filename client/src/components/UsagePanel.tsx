  ...
  return (
    <span className="flex items-center gap-1.5">
      ...
      <input
        ...
        className="w-20 rounded-input border border-edge bg-elevated px-1.5 py-0.5 text-tiny text-ink outline-none focus-visible:shadow-focusring focus:border-edge"
      />
