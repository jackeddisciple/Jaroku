 ...
 * logos as exempt from the stroke rule, and this is `JarokuGlyph`'s three contours traced from
 * `assets/mono.png` — the artwork as drawn, not a redrawing. What this adds is only the disc it
 * sits on: a solid glyph on a photograph needs a ground to be legible against, and the ground is
 * the app's own panel colour at high alpha rather than a tint, so the mark reads the same over a
 * pale gradient and a dark one.
 */
