...
//
// ONE SWITCH, FOUR DESTINATIONS. Threads left for the sidebar, where a chat now sits under its agent.
//
// ALL OF THEM ARE BUILT. Threads came first, Agents second, the
