...
-- TEXT rather than uuid: SQLite has no uuid type and the driver parity suite compares shapes,
-- not spellings. See db/shapeParity.
ALTER TABLE magic_link_tokens ADD COLUMN claimed_user_id TEXT;
...
ALTER TABLE magic_link_tokens ADD COLUMN collected_at TEXT;
